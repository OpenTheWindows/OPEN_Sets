module OPENSets.State {
    export class MainGame extends Phaser.State {
        ...
        createNewGameModel(pair: Models.Pair): Models.GameModel {
            var question: string;
            var rightAnswer = new Models.Option("", true);
            var wrongAnswer1 = new Models.Option("", false);
            var wrongAnswer2 = new Models.Option("", false);
            ...
            while (wrongAnswerPair1.name == pair.name || wrongAnswerPair2.name == pair.name || wrongAnswerPair1.name == wrongAnswerPair2.name) {
            ...
            var options = [rightAnswer, wrongAnswer1, wrongAnswer2];
